...
[Algodesk](https://www.algodesk.io/#/) is a website you can use to burn Algorand NFTs. Burning an NFT means to destroy it. You can only destroy NFTs that you've created.
