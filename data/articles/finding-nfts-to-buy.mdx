...
If you already know what the collection's address is, maybe you got it from Twitter or the collections' website, you can search for that collection directly on NFT Explorer. Just copy/paste the address into the search bar and hit enter. You'll be taken to the collection page.

The below example is the popular [AlGoofy](https://twitter.com/GoofyAlgo) collection.

![address search](/uploads/finding-nfts-to-buy/address-search.png)
![AlGoofy](/uploads/finding-nfts-to-buy/algoofy.png)
