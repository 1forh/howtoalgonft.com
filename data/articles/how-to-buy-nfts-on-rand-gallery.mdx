...
Clicking the green button with "210 algos" will start the process of buying the NFT. You will need to sign the transaction using your wallet to confirm the purchase. 
