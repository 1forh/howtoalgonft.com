...
date: 12/31/2021
summary: 'Quick overview on how to buy NFTs on Rand Gallery.'
---

## 1. First off, you'll need a wallet and some algos. Check out the <Link href="/"><a>homepage</a></Link> for guides on how to get started.

## 2. When you have a wallet and some algos, go to <a href='https://www.randgallery.com' target='_blank' rel='noreferrer'>Rand Gallery</a>.

![Rand Gallery homepage](/uploads/how-to-buy-nfts-on-rand-gallery/rand-gallery-homepage.png)

## 3. Click the `Sign in` link in the top right corner of the page and enter your [MyAlgo](https://myalgo.com/) password to sign in.
...
## 4. Now that you're signed in, you can buy NFTs.
...
Go to the collection's page. This example is the [MNGO](https://www.randgallery.com/collection/mngo/) collection. Going to the collection's page, you'll find listings for all of the NFTs in that collection that are for sale by users.

![Rand Gallery MNGO](/uploads/how-to-buy-nfts-on-rand-gallery/mngo.png)

Clicking on one of these listings will bring up that NFTs detail page.

![MNGO #425](/uploads/how-to-buy-nfts-on-rand-gallery/mngo-425.png)
...
When you do find a shuffle you want to purchase an NFT from, just go that shuffle's page on Rand Gallery. Most of the time you'll be able to find these links on Twitter or the collection's website.

The below example is a shuffle for the [Algato collection](https://twitter.com/AlGatoNFT). You can see a green `Shuffle` button and the price in algos right below it. You can also see that there are 46.6% of the NFTs still left in the shuffle. Once this hits 0%, the shuffle will end and you will no longer be able to buy any NFTs from it.

![Algato shuffle](/uploads/how-to-buy-nfts-on-rand-gallery/algato-shuffle.png)

When you do click the `Shuffle` button, you will go through the MyAlgo steps to purchase the NFT. When the transaction is successful, you will be awarded with a random Algato from the shuffle collection. You could possibly get a really rare Algato or a more common one. The fun part is trying for a rare one! Some shuffles allow you to do this multiple times but some limit to one time per wallet.

## 5. You can now see your new NFT purchase in your wallet. Enjoy!